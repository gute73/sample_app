				...
				**/
				...
				//*****************************************************************//
					...
					* Append the overlay to the body. 
					EDITED - 3/24/14 JF - needed to alter z-index stacking context
					**/	
					$('#PageWrapper').append('<div id="powertour-overlay"></div>');
				...
				//*****************************************************************//
					...
					**/
					function endTour(val){
						...
						**/	
						if(o_tourType == 'auto' || o_tourType == 'step' && val != undefined && typeof o_step[parseInt(val)].onHideStep == 'function'){
							o_step[parseInt(val)].onHideStep.call(this);
						}
						...
						**/	
						if (cur >= totalSteps){
							...
							**/	
							...
							var valuePrev = o_step[parseInt(i)];
				...
				//*****************************************************************//
					...
					**/
					function goToStep(i,prev){
						...
						**/	
						var value     = o_step[i];				
						var valuePrev = o_step[parseInt(val)];		
